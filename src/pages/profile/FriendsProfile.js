              ...
              <Card style={{border: '1px solid #ccc', position: 'relative'}}>
                ...
                <CardActions style={{display: 'flex', justifyContent: 'center'}}>
                  ...
                  {note && note.likes.includes( user._id ) ? (
                    ...
                    <IconButton aria-label="likes" disabled={double} onClick={()=> handleLikeNote(note._id)}>
                  ...
                  <Link to={`/user/notes/read/${note._id}`}>
                    <Button variant='contained' size='small' color='primary' disable='true'>
                      Read More...
                    </Button>
                  </Link>
                </CardActions>
                      ...
                      return (
                        <div key={ noteComment._id }>
                            ...
                            <span style={ { color: 'ThreeDDarkShadow', fontWeight: 'bold', paddingRight: '10px' } }>
                              { `${notes && noteComment.postedBy.firstName } ${ noteComment.postedBy.lastName }` }
